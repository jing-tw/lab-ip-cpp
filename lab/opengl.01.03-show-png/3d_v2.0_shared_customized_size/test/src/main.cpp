...
int test_create_scene()
{
    ...
    MyPicture *myPicture = new MyPictureCV(10.0f, 0.0f);
    ...
    glm::vec3 cameraPosition = glm::vec3(50.0f, 50.0f, 50.0f); // glm::vec3(0.0f, 0.0f, 3.0f); // glm::vec3(3.0f, 3.0f, 3.0f); // glm::vec3(5.0f, 5.0f, 5.0f); // Set the camera position at (1, 1, 3)
