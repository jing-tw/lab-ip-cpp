...
int MovePicture_1()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
       ...
       if (offsetX <= 0.0f && bUP == false){
        ...
        myPicture->display(0.0f, 0.0f, offsetX*4, view, projection);
...
int MovePicture_9() {
   ...
   while (!glfwWindowShouldClose(window)) {
       ...
       for(int i = 0; i < num; i++){
            switch(i){
            case 0:
                myPictures[i]->display(offsetX , 0.0f , 0.0f, view, projection);
                break;
            case 1:
                myPictures[i]->display(-offsetX , 0.0f , 0.0f, view, projection);
                break;
            case 2:
                 myPictures[i]->display(0.0f, offsetX, 0.0f, view, projection);
                break;
            case 3:
                myPictures[i]->display(0.0f, -offsetX, 0.0f, view, projection);
                break;
            case 4:
                 myPictures[i]->display(offsetX , offsetX , 0.0f, view, projection);
                break;
            case 5:
                myPictures[i]->display(-offsetX , -offsetX , 0.0f, view, projection);
                break;
            ...
            case 7:
                ...
                break;
            case 8:
                myPictures[i]->display(0.9f, 0.9f, offsetX * 4.0, view, projection);
                break;
            default:
